...
calculator.resizable(0, 10)#remove or change this in order to get different screen sizes
...
class Application(Frame):
	...
	def calculateExpression(self):#python's calculate function
		...
		try:
			...
			messagebox.showinfo("ERROR", "This is not possible!", icon="warning", parent=calculator)
